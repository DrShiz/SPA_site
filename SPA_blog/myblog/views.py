...
from .forms import SignUpForm, SignInForm, FeedBadkForm, CommentForm
...
class FeedBackView(View):
    ...
    def post(self, request, *args, **kwargs):
        form = FeedBadkForm(request.POST)
        if form.is_valid():
            ...
            try:
                send_mail(f'От {name} | {subject}', message, from_email, ['shizdryeah@gmail.com'])
